...
(defun work-related-burnout-questions ()
  ...
  (list (list "Do you feel worn out at the end of the working day?" "7." nil)
        ...
        ; (list "Do you have enough energy for family and friends during leisure time?" "10." t)
        (list "Is your work emotionally exhausting?" "9." nil)
        (list "Does your work frustrate you?" "10." nil)
        (list "Do you feel burnt out because of your work?" "11." nil)
        ))

(defun client-related-burnout-questions ()
  "Return a list of client-related burnout questions."
  (list (list "Do you find it hard to work with clients?" "12." nil)
        (list "Does it drain your energy to work with clients?" "13." nil)
        (list "Do you find it frustrating to work with clients?" "14." nil)
        ; (list "Do you feel that you give more than you get back when you work with clients?" "17." nil)
        (list "Are you tired of working with clients?" "15." nil)
        (list "Do you sometimes wonder how long you will be able to continue working with clients?" "16." nil)))
